    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
        <form method="post" enctype="multipart/form-data" action="<?php echo site_url('costsheetreport1/insert') ?>">
                ...
                <div class="row sm_toppadding">                
                    <div class="col-md-6">
                            <div class="row form-group">                                
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="broker1" class="form-control">
                                    </div>                                                   
                            </div>
                            <div class="row form-group">                                
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="broker2" class="form-control">
                                    </div>                                                   
                            </div>
                            <div class="row form-group">                                
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="broker3" class="form-control">
                                    </div>                                                   
                            </div>   
                            <div class="row form-group">                                
                                    <div class="col-md-3">
                            ...
                            <table class="table-sm profitloss" style="width:100%;">
                                      ...
                                      <tbody id="costsheetdescription">
                                        <tr class="costsheetdes">
                                            <td><input type="text" name="des1[]" class="form-control" required></td>
