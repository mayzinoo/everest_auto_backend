...
<div id="container">
	<div id="body" class="row">
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: 10px;">
				...
				<tr>
					...
					<td style="width: 45%;border-right:1px solid #e6e6e6;border-bottom:1px solid #e6e6e6">
						<?php echo $chinaprivatecar->policy_no;?>
					</td>
				...
				<tr>
					...
					<td style="border-right:1px solid #e6e6e6;border-bottom:1px solid #e6e6e6">
						<?php echo $chinaprivatecar->cover_noteno;?>
					</td>
					<td rowspan="2" style="vertical-align: top;border-right:1px solid #e6e6e6;border-bottom:1px solid #e6e6e6">
						<?php echo $chinaprivatecar->agent_brokercode;?>
					</td>	
				</tr>
		</table>
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: -7px;">
				...
				<tr>
					<td colspan="2" style="border-right: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->nric;?>
					</td>
					<td colspan="2" style="">
						<?php echo $chinaprivatecar->dob;?>
					</td>
				</tr>
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;">
				...
				<tr>
					<td style="border-right: 1px solid #d1d3d4;">
						<span>
							<?php if($chinaprivatecar->marital_status=="Single"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->marital_status=="Married"){ ?>
					...
					<td style="border-right: 1px solid #d1d3d4;">
						<span>
							<?php if($chinaprivatecar->hirer_gender=="Male"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->hirer_gender=="Female"){ ?>
					...
					<td style="border-right: 1px solid #d1d3d4;">
						<span>
							<?php if($chinaprivatecar->nationality=="Singaporean"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->nationality=="Others"){ ?>
				...
				<tr>
					<td colspan="2">
						<?php echo $chinaprivatecar->address;?>
					</td>
					<td>
						Postal Code: <?php echo $chinaprivatecar->postal_code;?>
					</td>
				</tr>
		</table>
		<table style="width: 100%;border: 1px solid #e6e6e6;">
				...
				<tr>
					<td style="height: 40px;vertical-align: top;border-right: 1px solid #d1d3d4;">
						Home No.: <br/><?php echo $chinaprivatecar->home_no;?>
					</td>
					<td style="vertical-align: top;border-right: 1px solid #d1d3d4;">
						Office No.: <br/><?php echo $chinaprivatecar->office_no;?>
					</td>
					<td style="vertical-align: top;border-right: 1px solid #d1d3d4;">
						Mobile No. (Mandatory): <br/><?php echo $chinaprivatecar->mobile_no;?>
					</td>
					<td style="vertical-align: top;border-right: 1px solid #d1d3d4;">
						Email Address (Mandatory): <br/><?php echo $chinaprivatecar->email;?>
					</td>
				</tr>
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;">
				...
				<tr>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->sg_driving_license;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->occupationn;?>
					</td>
				</tr>
		</table>
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: 0px;">
				...
				<tr>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->reg_no;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->make;?> <?php echo $chinaprivatecar->model;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->manufacture_year;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->dateof_reg;?>
					</td>
				</tr>
				<tr>
					<td style="background: #dce6f2;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
				...
				<tr>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->engineno;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->chassisno;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->cctonnage;?>
					</td>
					<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->seating_capacity;?>
					</td>
				</tr>
				<tr>
					<td style="background: #dce6f2;border-right: 1px solid #d1d3d4;">
					...
					<td colspan="3" style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<span>
							<?php if($chinaprivatecar->electric_vehi=="Yes"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->electric_vehi=="No"){ ?>
				...
				<tr>
					...
					<td colspan="3" style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="Saloon"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="Hatchback"){ ?>
								<span style="font-size: 14px">&#9745;</span> Hatchback
							<?php }else{ ?>
								❑ Hatchback
							<?php } ?>					
						</span>
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="Stationwagon"){ ?>
								<span style="font-size: 14px">&#9745;</span> Stationwagon
							<?php }else{ ?>
								❑ Stationwagon
							<?php } ?>					
						</span>
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="SUV"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="Roadster"){ ?>
								<span style="font-size: 14px">&#9745;</span> Roadster
							<?php }else{ ?>
								❑ Roadster
							<?php } ?>					
						</span>
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="MPV"){ ?>
								<span style="font-size: 14px">&#9745;</span> MPV
							<?php }else{ ?>
								❑ MPV
							<?php } ?>					
						</span>
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="Jeep"){ ?>
								<span style="font-size: 14px">&#9745;</span> Jeep
							<?php }else{ ?>
								❑ Jeep
							<?php } ?>					
						</span>
						<span>
							<?php if($chinaprivatecar->typeof_vehi=="Coupe / Convertible / Cabriolet"){ ?>
								<span style="font-size: 14px">&#9745;</span> Coupe / Convertible / Cabriolet
							<?php }else{ ?>
								❑ Coupe / Convertible / Cabriolet
							<?php } ?>					
						</span>
					</td>
				</tr>
				<tr>
					<td style="background: #dce6f2;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						Type of Vehicle <br/>
						<span style="font-size: 8px;">(Tick all that is applicable)</span>
					</td>
					<td colspan="3" style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<span>
							<?php if($chinaprivatecar->typeof_vehi2=="Off Peak Car"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->typeof_vehi2=="Parallel Import Models"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->typeof_vehi2=="Modified Vehicle"){ ?>
								<span style="font-size: 14px">&#9745;</span> Modified Vehicle (Decline)
							<?php }else{ ?>
								❑ Modified Vehicle (Decline)
							<?php } ?>					
						</span>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->hire_purchase_cmy;?>
					</td>
				</tr>
		</table>
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: -7px;">
				...
				<tr>
					...
					<td colspan="3" style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						From <?php echo $chinaprivatecar->periodof_cover_from;?> To <?php echo $chinaprivatecar->periodof_cover_to;?> <span style="text-align: right;">(To coincide with Road Tax expiry date if possible)</span>
					</td>
				</tr>
				<tr>
					...
					<td style="width: 60%;">
						<span>
							<?php if($chinaprivatecar->typeof_cover=="Comprehensive"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->typeof_cover=="Third Party Fire & Theft"){ ?>
						...
						<span>
							<?php if($chinaprivatecar->typeof_cover=="Third Party Only"){ ?>
				...
				<tr>
					...
					<td>
						<span>
							<?php if($chinaprivatecar->autosafe_scheme=="Yes"){ ?>
								<span style="font-size: 14px">&#9745;</span> Yes
							<?php }else{ ?>
								❑ Yes
							<?php } ?>					
					...
					<td>
						<span>
							<?php if($chinaprivatecar->autosafe_scheme=="No"){ ?>
								<span style="font-size: 14px">&#9745;</span> No
							<?php }else{ ?>
								❑ No
							<?php } ?>					
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: -7px;">
				...
				<tr>
					...
					<td style="width: 60%;">
						(a) Will the vehicle be used for hire or reward?						
					</td>
					<td>
						<span>
							<?php if($chinaprivatecar->privatecar_q1=="Yes"){ ?>
								<span style="font-size: 14px">&#9745;</span> Yes
							<?php }else{ ?>
								❑ Yes
							<?php } ?>					
					...
					<td>
						<span>
							<?php if($chinaprivatecar->privatecar_q1=="No"){ ?>
								<span style="font-size: 14px">&#9745;</span> No
							<?php }else{ ?>
								❑ No
							<?php } ?>					
				...
				<tr>
					<td>
						(b) Will the vehicle be used for carriage of passengers for hire or reward?						
					</td>
					<td>
						<span>
							<?php if($chinaprivatecar->privatecar_q2=="Yes"){ ?>
								<span style="font-size: 14px">&#9745;</span> Yes
							<?php }else{ ?>
								❑ Yes
							<?php } ?>					
					...
					<td>
						<span>
							<?php if($chinaprivatecar->privatecar_q2=="No"){ ?>
								<span style="font-size: 14px">&#9745;</span> No
							<?php }else{ ?>
								❑ No
							<?php } ?>					
				...
				<tr>
					<td style="height: 28px;vertical-align: top;">
						(c) How often do you drive in to Malaysia?			
					</td>
					<td>
						<?php echo $chinaprivatecar->drive_malaysia;?>
					</td>
				</tr>
		</table>
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: -7px;">
				<tr>
					<td colspan="5" style="font-size: 12px;padding:5px;background: #006cb7;color: #fff;">
						Coverage Required
					</td>
				</tr>
				<tr>
					<td colspan="5">
						Named Driver(s) - must be above 29 years old or below 65 years old as at last birthday with at least 3 years Singapore driving experience
					</td>
				</tr>
				<tr>
					<td style="width: 25%;background: #dce6f2;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						Name of Driver
					</td>
					<td style="background: #dce6f2;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						D.O.B
				...
				<tr>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->driver_name;?>
					</td>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->driver_dob;?>
					</td>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->driver_licensepassdate;?>
					</td>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->driver_nric;?>
					</td>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
						<?php echo $chinaprivatecar->driver_gender;?>
					</td>
				</tr>
				<tr>
					<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
				...
				<tr>
					<td colspan="5">
						<u>This Section applies only to Private Car Policy:</u><br/>
						Insured and Named Drivers enjoy one-time excess waiver (up to S$500 for non-continental cars and up to S$1,000 for continental cars) in the event of an Own Damage Claim made at our Authorised Workshops.<br/><br/>

						Unnamed Driver Additional Excess:<br/>
						<table style="width: 50%;border: 1px solid #e6e6e6;text-align: center;margin-top:5px">
							<tr>
						...
						<span style="font-size: 8px;">*Age as at date of accident <br/>
						**S$3,500 is the maximum unnamed driver additional excess applicable for young and inexperienced drivers unless otherwise specified in the policy schedule.</span>
					</td>
				</tr>
		</table>
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: -7px;">
				...
				<tr>
					<td style="line-height: 20px;">
						1. Replace at any Authorised Distributor Workshops (within warranty period - maximum 3 years) ................... unlimited <br/>
						2. Replace at any of our Authorised Workshops ................................................................................................ unlimited <br/>
						3. Other than the above ..................................................................................................................................... S$2,000 <br/>
						4. Option to increase coverage at Non-Authorised Workshops <br/>
		...
		<table style="width: 100%;border: 1px solid #e6e6e6;margin-top: -7px;">
				...
				<tr>
					<td style="width: 3%;line-height: 15px;vertical-align: top;">
						1.
					</td>
					<td style="line-height: 15px;vertical-align: top;">
						Loss of Use <br/>
						(cap @ S$50 X 5 days per policy period) ............... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP50"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$50/-
							<?php }else{ ?>
								❑ AP: S$50/-
							<?php } ?>					
						</span><br/>
						(cap @ S$50 X 10 days per policy period) ............ 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP75"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$75/-
							<?php }else{ ?>
								❑ AP: S$75/-
							<?php } ?>					
						</span><br/>
						(cap @ S$100 X 5 days per policy period) ........... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP100"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$100/-
							<?php }else{ ?>
								❑ AP: S$100/-
							<?php } ?>					
						</span><br/>
						(cap @ S$100 X 10 days per policy period) .......... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP150"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$150/-
							<?php }else{ ?>
								❑ AP: S$150/-
							<?php } ?>					
						</span><br/>
				...
				<tr>
					...
					Buy down $250 ...................................................... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP37.5"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$37.50/-
							<?php }else{ ?>
								❑ AP: S$37.50/-
							<?php } ?>					
						</span><br/>
					...
					Buy down $750 ...................................................... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP112.5"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$112.50/-
							<?php }else{ ?>
								❑ AP: S$112.50/-
							<?php } ?>					
						</span><br/>
					...
					Buy down $1,250 ................................................... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP187.5"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$187.50/-
							<?php }else{ ?>
								❑ AP: S$187.50/-
							<?php } ?>					
						</span><br/>
					Buy down $1,500 ................................................... 
						<span>
							<?php if($chinaprivatecar->lossof_use=="AP225"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$225/-
							<?php }else{ ?>
								❑ AP: S$225/-
							<?php } ?>					
						</span><br/>
				...
				<tr>
					...
					<td style="line-height: 15px;vertical-align: top;">
						Protection Package ............................................... 
						<span>
							<?php if($chinaprivatecar->protection_pkg=="AP150"){ ?>
								<span style="font-size: 14px">&#9745;</span> AP: S$150/-
							<?php }else{ ?>
								❑ AP: S$150/-
							<?php } ?>					
				...
				<tr>
					<td colspan="2">
						...
						(Total loss protection, Loan Protection, SOS Emergency Evacuation and Personal Accident to insured increased to S$50,000
						</p>
					</td>
				</tr>
		</table>
		<table style="width: 100%;border-top: 1px solid #e6e6e6;border-left: 1px solid #e6e6e6;border-right: 1px solid #e6e6e6;margin-top: 100px;">
				<tr>
					<td colspan="2" style="font-size: 12px;padding:5px;background: #006cb7;color: #fff;">
				...
				<tr>
					...
					<td>
						...
						<span>
							<?php if($chinaprivatecar->claim_exp=="No"){ ?>
								<span style="font-size: 14px">&#9745;</span> No
							<?php }else{ ?>
								❑ No
							<?php } ?>					
						...
						<span>
							<?php if($chinaprivatecar->claim_exp=="Yes"){ ?>
								<span style="font-size: 14px">&#9745;</span> Yes
							<?php }else{ ?>
								❑ Yes
							<?php } ?>					
						...
						<table style="width: 100%;border: 1px solid #e6e6e6;text-align: center;margin-top: 5px;">
							...
							<tr>
								<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
									<?php echo $chinaprivatecar->claim_expyes_date;?>
								</td>
								<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
									<?php echo $chinaprivatecar->info_desofaccident;?>
								</td>
								<td style="border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
									<?php echo $chinaprivatecar->claim_expyes_amt;?>
								</td>
							</tr>
							<tr>
								<td style="height: 20px;border-right: 1px solid #d1d3d4;border-bottom: 1px solid #d1d3d4;">
				...
				<tr>
					...
					<td style="vertical-align: top;">
						...
						<span>
							<?php if($chinaprivatecar->receive_notice=="No"){ ?>
								<span style="font-size: 14px">&#9745;</span> No
							<?php }else{ ?>
								❑ No
							<?php } ?>					
						...
						<span>
							<?php if($chinaprivatecar->receive_notice=="Yes"){ ?>
								<span style="font-size: 14px">&#9745;</span> Yes
							<?php }else{ ?>
								❑ Yes
							<?php } ?>					
...
...................................................................................................................................................................................................................
				...
				<tr>
					...
					<td>
						...
						<span>
							<?php if($chinaprivatecar->ncd=="Yes"){ ?>
								<span style="font-size: 14px">&#9745;</span> Yes
							<?php }else{ ?>
								❑ Yes
							<?php } ?>					
						</span>
						If yes, please provide below details:  <br/>
						<br/>
					</td>
				</tr>
		</table>
		<table style="width:100%;border-left: 1px solid #e6e6e6;border-right: 1px solid #e6e6e6;border-bottom: 1px solid #e6e6e6;">
			<tr>
				<td>
					Present/Previous Insurer: <?php echo $chinaprivatecar->present_previous_insurer;?>
				</td>
				<td>
					NCD:  <?php echo $chinaprivatecar->ncd_txt;?>
				</td>
				<td>
					Vehicle No: <?php echo $chinaprivatecar->vehiname;?>
				</td>
			</tr>
			<tr>
				<td>
					Policy No: <?php echo $chinaprivatecar->info_policy_no;?>
				</td>
				<td colspan="2">
					Expiry Date: <?php echo $chinaprivatecar->expiry_date;?>
				</td>
			</tr>
			<tr><td></td></tr>
		</table>
...
from my / our previous insurance company.
		...
		<table style="width:100%;border:1px solid #e6e6e6">
			<tr>
				<td style="height: 70px;width: 50%;vertical-align: bottom;border-right: 1px solid #e6e6e6;">
					<?php echo $chinaprivatecar->proposalsign_date;?> <br/>
					Date
				</td>
				<td style="vertical-align: bottom;">
					<img src="<?php echo 'data:image/jpg;base64,'.base64_encode(file_get_contents('./upload/sign/'.$chinaprivatecar->signof_proposal)); ?>" class="gg" style="width:100px;height: 30px;"><br/>
		...
		<table style="width: 100%;border: 1px solid #e6e6e6; margin-top: 40px;">
				<tr>
					<td style="font-size: 12px;padding:5px;background: #006cb7;color: #fff;">
				...
				<tr>
					<td>
						...
						<p style="font-size: 10.5px;">
							...
							<span>
								<?php if($chinaprivatecar->marketing_consent=="Email"){ ?>
							...
							<span>
								<?php if($chinaprivatecar->marketing_consent=="Mail"){ ?>
							...
							<span>
								<?php if($chinaprivatecar->marketing_consent=="SMS"){ ?>
							...
							<span>
								<?php if($chinaprivatecar->marketing_consent=="Voice"){ ?>
...
(iii) I / We understand that I / we may withdraw my / our consent through the withdrawal form at any time.<br/>
		...
		<div style="marign:20px 0px 20px 0px">
			<p style="font-size: 10.5px;">
				Name: <?php echo $chinaprivatecar->agree_name;?>
			</p>
		</div>
		<div style="marign:20px 0px 20px 0px">
			<p style="font-size: 10.5px;">
				NRIC No: <?php echo $chinaprivatecar->agree_nric;?>
			</p>
		</div>
		<div style="marign:20px 0px 20px 0px">
			<p style="font-size: 10.5px;">
				Date: <?php echo $chinaprivatecar->agree_date;?>
			</p>
		</div>
	</div>
</div>
