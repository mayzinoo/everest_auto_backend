    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <form method="post" enctype="multipart/form-data" action="<?php echo site_url('sales_receipt/update') ?>">
                  ...
                  <div class="row sm_toppadding">
                      <div class="col-md-6">                            
                            <div class="row form-group">
                                  ...
                                  <div class="col-md-7">
                                      <input type="text" name="sellingprice" id="sellingprice" value="<?php echo $salesreceipt->selling_price;?>" class="form-control">
                                  </div>       
                            </div>
                            <div class="row form-group">
                                  <div class="col-md-4">
