    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <form method="post" enctype="multipart/form-data" action="<?php echo site_url('or_receipt/update') ?>">
                  ...
                  <div class="row sm_toppadding">
                      ...
                      <div class="col-md-6"> 
                            <div class="row form-group">
                                  ...
                                  <div class="col-md-7">
                                      <input type="date" name="date" value="<?php echo $orreceipt->date;?>" class="form-control">
                                  </div>       
                            </div>    
                            <div class="row form-group">
                                  <div class="col-md-3">
            ...
            <div class="card-footer">
                  <div class="row right">
                      <div class="col-md-12">
                          <a href="or_receipt/" class="btn mybtn btn-default">Cancel</a>
