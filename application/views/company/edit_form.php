    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <form method="post" enctype="multipart/form-data" action="<?php echo site_url('company/update') ?>">
                ...
                <div class="row sm_padding">                    
                        <div class="col-md-6">                                    
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="cmyname" value="<?php echo $company->cmy_name;?>" class="form-control" >
                                    </div>       
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-5">
