		                ...
		                ?> 
		                    <tr>
		                        ...
		                        <td>
									...
									<a onclick="return confirm('Are you sure to delete?')" href="<?php echo base_url() .'features/delete_features/'.$row->id;?>" type="button" class="delete-asset btn btn-danger btn-xs color-white">
...
<div class="modal fade" id="modal-edit-feature" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
      	 <form method="post" action="<?php echo site_url('features/update_feature') ?>">
		        <div class="modal-header">
