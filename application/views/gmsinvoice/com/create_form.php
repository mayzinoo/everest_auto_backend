    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <form method="post" enctype="multipart/form-data" action="<?php echo site_url('gms_com/insert') ?>">
            <div class="card-body">
                  <div class="row sm_toppadding">
                      <div class="col-md-6"> 
                            ...
                            <div class="row form-group">
                                  ...
                                  <div class="col-md-7">
                                      <textarea name="address" id="address" id="address" class="form-control"></textarea>
                                  </div>       
                            </div>
