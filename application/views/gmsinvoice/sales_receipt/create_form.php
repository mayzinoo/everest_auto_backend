    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <form method="post" enctype="multipart/form-data" action="<?php echo site_url('gms_sales_receipt/insert') ?>">
            <div class="card-body">
                  ...
                  <div class="row sm_toppadding">
                      <div class="col-md-6">                            
                            ...
                            <div class="row form-group">
                                  ...
                                  <div class="col-md-7">
                                      <input type="text" name="insurancepremium" id="insurancepremium" class="form-control">
                                  </div>       
                            </div>
                            <div class="row form-group">
                                  <div class="col-md-4">
                                  ...
                                  <div class="col-md-7">
                                      <input type="text" name="facilitiesfee" id="facilitiesfee" class="form-control">
                                  </div>       
                            </div>
                            <div class="row form-group">
                                  <div class="col-md-4">
                                  ...
                                  <div class="col-md-7">
                                      <input type="text" name="loanadvpayment" id="loanadvpayment" class="form-control">
                                  </div>       
                            </div>
                            <div class="row form-group">
                                  <div class="col-md-4">
...
<script>
  $(document).ready(function() {
      ...
      gettotalamt();
      $("#insurancepremium,#facilitiesfee,#loanadvpayment,#sellingprice, #totalpayable, #deposit, #fullsetteamt, #loanamt").on("keydown keyup", function() {
          gettotalamt();
      });
  });
  function gettotalamt() 
  {
        ...
        var num4 = document.getElementById('insurancepremium').value;
        var num5 = document.getElementById('facilitiesfee').value;
        var num6 = document.getElementById('loanadvpayment').value;
        var num7 = document.getElementById('sellingprice').value;

        var result1 = parseFloat(num4) + parseFloat(num5) + parseFloat(num6)+ parseFloat(num7);
            if (!isNaN(result1)) {                  
              document.getElementById('totalpayable').value = result1.toFixed(2);
            }
      
        var result2 = parseFloat(num1) + parseFloat(num2) + parseFloat(num3);
            if (!isNaN(result2)) {                  
              document.getElementById('totaldeduction').value = result2.toFixed(2);
            }
        var result3 = parseFloat(result1) - parseFloat(result2);
            if (!isNaN(result3)) {                  
              document.getElementById('balancedue').value = result3.toFixed(2);
            }
  }
