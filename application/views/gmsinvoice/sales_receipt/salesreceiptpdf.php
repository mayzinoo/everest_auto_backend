...
<div id="container">
	<div id="body">
		...
		<div class="col-sm-12"><p>Being the sale of vehicle registration no: <?php echo $salesreceipt->vehiregno;?></p></div>
		...
		<div class="col-sm-12 smm_toppadding">
			<div class="col-sm-6">
					...
					<img src="<?php echo base_url() .'upload/sign/'.$salesreceipt->signof_author;?>" class="img-responsive" style="width:80px;height:auto;">
					<p>Authorised Signature</p>
			</div>
			<div class="col-sm-6">
					<p>Agreed & Accepted by Buyer</p>
					<img src="<?php echo base_url() .'upload/sign/'.$salesreceipt->signof_buyer;?>" class="img-responsive" style="width:80px;height:auto;">
					<p>Authorised signature of Buyer<br/>Company Stamp </p>
			</div>
		</div>
	</div>
</div>
