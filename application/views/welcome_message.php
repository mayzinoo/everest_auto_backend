...
<head>
    ...
    <title>Everest Auto | Login</title>
...
<style>
        .cmytitle{
          color: #711317 !important;
          font-size: 21px !important;
        }
        .color--light-blue{
            background: #711317 !important;
        }
        .color--dark-gray{
        ...
        .getmdl-select .mdl-menu .mdl-menu__item, .mdl-textfield__input, .mdl-textfield textarea{
                ...
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="mdl-card__title-text text-color--smooth-gray cmytitle">EVEREST AUTO ADMIN DASHBOARD</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="login-name text-color--white">Sign in</span>
                            <span class="login-secondary-text text-color--smoke">Enter fields to sign in to EVEREST</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
