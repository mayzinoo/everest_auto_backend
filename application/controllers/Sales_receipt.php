...
class Sales_receipt extends CI_Controller
{
    ...
    function index()
    {
        ...
        {           
            $data["salesreceipt"] =$this->db->query("SELECT * FROM sales_receipt WHERE type='gst'");
            $data['content']="gstinvoice/sales-receipt/index";
    ...
    function create_form()
    {
        ...
        {    
            ...
            $data['hirerlist']=$this->Gstinvoice_model->gethirerlist();
            $data['vehilist']=$this->Gstinvoice_model->gstvehilist();
            $data['content']="gstinvoice/sales-receipt/create_form";
            $this->load->view("template",$data);
        }else{
          redirect('/');
        }
    ...
    function edit_form()
    {
        ...
        if($this->session->userdata("email") && $this->session->userdata("password") && $role=="admin" || $role=="sale")
        {
            ...
            $data['content']="gstinvoice/sales-receipt/edit_form";
            $this->load->view("template",$data);
        }else{
            redirect('/');
        }
    ...
    function salesreceipt_pdf()
    {
        ...
        $pdf_view=$this->load->view('gstinvoice/sales-receipt/salesreceiptpdf',$data, true);
